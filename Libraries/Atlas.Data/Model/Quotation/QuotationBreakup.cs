...
{
    public class QuotationBreakup : XPLiteObject
    {
        ...
        public decimal AdditionalVapAmount { get; set; }
        public decimal RoundingInterest { get; set; }

        public QuotationBreakup() : base() { }
        public QuotationBreakup(Session session) : base(session) { }
