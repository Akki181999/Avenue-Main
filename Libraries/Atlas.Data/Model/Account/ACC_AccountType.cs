    ...
    public DateTime? DisabledDate
    {
      ...
      set
      {
        ...
        public decimal MinSalary
        {
            ...
            set
            {
                SetPropertyValue("MinSalary", ref _minSalary, value);
            }
        }

        private decimal _NLRMinScore;
        [Persistent]
        public decimal NLRMinScore
        {
            get
            {
                return _NLRMinScore;
            ...
            set
            {
                SetPropertyValue("NLRMinScore", ref _NLRMinScore, value);
            }
        }
