...
namespace Atlas.Domain.Model
{
  public class PER_Person : XPCustomObject
  {
    ...
    public Host Host
    {
      ...
      set { _Host.Value = value; }
        ...
        public int MaritalStatusId
        {
            ...
            set { SetPropertyValue("MaritalStatusId", ref _MaritalStatusId, value); }
        }

        private int? _CountryOfBirthId;
        [Persistent]
        public int? CountryOfBirthId
        {
            get { return _CountryOfBirthId; }
            set { SetPropertyValue("CountryOfBirthId", ref _CountryOfBirthId, value); }
        }
        ...
        {
            get { return _PropertyOwnershipId; }
            set { SetPropertyValue("PropertyOwnershipId", ref _PropertyOwnershipId, value); }
        }
    ...
    public DateTime? LastEditedDT
    {
     ...
     private long _ASSPersonId;

     [Persistent]
     public long ASSPersonId
     {
         get { return _ASSPersonId; }
         set { SetPropertyValue("AssPersonId", ref _ASSPersonId, value); }
     }
