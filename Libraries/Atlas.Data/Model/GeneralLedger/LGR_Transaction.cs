using Atlas.Domain.Model.PaymentModes;
...
namespace Atlas.Domain.Model
{
    public class LGR_Transaction : XPLiteObject
    {
        ...
        public string BankRefCode
        {
            ...
            set
            {
                SetPropertyValue("BankRefCode", ref _bankRefCode, value);
            }
        }
        ...
        private int _LGR_TransTypeGroupId;
        [Persistent("LGR_TransTypeGroupId")]
        public int LGR_TransTypeGroupId
        {
            get
            {
                return _LGR_TransTypeGroupId;
            }

            set
            {
                SetPropertyValue("LGR_TransTypeGroupId", ref _LGR_TransTypeGroupId, value);
            }
        }

        private bool _IsfinancialTransaction;
        [Persistent("IsfinancialTransaction")]
        public bool IsfinancialTransaction
        {
            get
            {
                return _IsfinancialTransaction;
            }
            set
            {
                SetPropertyValue("IsfinancialTransaction", ref _IsfinancialTransaction, value);
            }
        }
