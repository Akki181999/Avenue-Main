...
{
    public sealed class DebiCheckReportDisputed : XPBaseObject
    {
        ...
        public DebiCheckReportDisputed() : base() { }
        public DebiCheckReportDisputed(Session session) : base(session) { }
