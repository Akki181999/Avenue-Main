...
{
    public class RealPayDebiCheckLogin: XPLiteObject
    {
        public RealPayDebiCheckLogin() : base() { }
        public RealPayDebiCheckLogin(Session session) : base(session) { }

        private Int64 _RealPayDebiCheckLoginId;
        [Key(AutoGenerate = true)]
        public Int64 RealPayDebiCheckLoginId
        {
            get
            {
                return _RealPayDebiCheckLoginId;
            }
            set
            {
                SetPropertyValue("RealPayDebiCheckLoginId", ref _RealPayDebiCheckLoginId, value);
            }
        }
