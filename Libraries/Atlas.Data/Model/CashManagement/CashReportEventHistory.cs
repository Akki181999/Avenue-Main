...
{
    public sealed class CashReportEventHistory : XPCustomObject
    {
        private Int64 _CashReportEventHistoryId;
        [Key(AutoGenerate = true)]
        public Int64 CashReportEventHistoryId
        {
            get
            {
                return _CashReportEventHistoryId;
            }
            set
            {
                SetPropertyValue("CashReportEventHistoryId", ref _CashReportEventHistoryId, value);
            }
        }
        ...
        public CashReportEventHistory() : base() { }
        public CashReportEventHistory(Session session) : base(session) { }
    }
}
