...
{
    public class RealPayReportBatch : XPBaseObject
    {
        public RealPayReportBatch() : base() { }
        public RealPayReportBatch(Session session) : base(session) { }

        private Int64 _realpayReportBatchId;
        [Key(AutoGenerate = true)]
        public Int64 RealPayReportBatchId
        {
            get
            {
                return _realpayReportBatchId;
            }
            set
            {
                SetPropertyValue("RealPayReportBatchId", ref _realpayReportBatchId, value);
            }
        }
        ...
        private Int64 _realpayLoginId;
        [Persistent]
        public Int64 RealPayLoginId
        {
            get
            {
                return _realpayLoginId;
            }
            set
            {
                SetPropertyValue("RealPayLoginId", ref _realpayLoginId, value);
            }
        }
