...
namespace Atlas.Domain.Model
{
    public class BRN_Branch : XPCustomObject
    {
        ...
        private bool _NotifyCustomer;
        [Persistent]
        public bool NotifyCustomer
        {
            get { return _NotifyCustomer; }
            set { SetPropertyValue("NotifyCustomer", ref _NotifyCustomer, value); }
        }
        ...
        public string BranchName
        {
            ...
            set { SetPropertyValue("BranchName", ref _BranchName, value); }
        }
        ...
        public string Email_Address
        {
            ...
            set { SetPropertyValue("Email_Address", ref _Email_Address, value); }
        }
        ...
        public string Weekends
        {
            ...
            set { SetPropertyValue("Weekends", ref _Weekends, value); }
        }
        ...
        private string _AccPacBranchCode;
        [Persistent]
        public string AccPacBranchCode
        {
            get { return _AccPacBranchCode; }
            set { SetPropertyValue("AccPacBranchCode", ref _AccPacBranchCode, value); }
        }

        private decimal? _FirstInterestRate;
        [Persistent]
        public decimal? FirstInterestRate
        {
            get
            {
                return _FirstInterestRate;
            }
            set
            {
                SetPropertyValue("FirstInterestRate", ref _FirstInterestRate, value);
            }
        }

        private decimal? _SecondInterestRate;
        [Persistent]
        public decimal? SecondInterestRate
        {
            get
            {
                return _SecondInterestRate;
            }
            set
            {
                SetPropertyValue("SecondInterestRate", ref _SecondInterestRate, value);
            }
        }
