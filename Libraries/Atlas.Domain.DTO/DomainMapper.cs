...
using Atlas.Domain.Model.SalesRep;
  ...
  public static class DomainMapper
  {
    public static void Map()
    {
      ...
      AutoMapper.Mapper.CreateMap<TAR_BranchCIMonthly, TAR_BranchCIMonthlyDTO>();
            ...
            #region BackOffice
            AutoMapper.Mapper.CreateMap<BOS_CustomerHistory, BOS_CustomerHistoryDTO>();
            AutoMapper.Mapper.CreateMap<Auth_User, Auth_UserDTO>();
            AutoMapper.Mapper.CreateMap<BOS_Role, BOS_RoleDTO>();
            AutoMapper.Mapper.CreateMap<BOS_Action, BOS_ActionDTO>();
            AutoMapper.Mapper.CreateMap<PER_Person, PER_PersonDTO>();

            AutoMapper.Mapper.CreateMap<SalesRep, Atlas.Domain.DTO.SalesRep.SalesRepDto>();
            AutoMapper.Mapper.CreateMap<SalesRepType, Atlas.Domain.DTO.SalesRep.SalesRepTypeDto>();
            AutoMapper.Mapper.CreateMap<SalesRep, Atlas.Domain.DTO.SalesRep.SalesManagerDto>();
            #endregion
        }
    }
}